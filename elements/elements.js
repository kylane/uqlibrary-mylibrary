...
window.addEventListener('WebComponentsReady', function () {
    ...
    if (window.location.port === '') {  // if production
      page.base(app.baseUrl.replace(/\/$/, '//mylibrary'));
    }
...
(function () {
      Polymer({
        is: 'uqlibrary-api-library-hours',
        properties: {
          baseUri: {
            type: String,
            value: '/library_hours'
         ...
         *
         * @event uqlibrary-api-library-hours
         */
        created: function () {
        },
        ready: function () {
          ...
          this.$.list.addEventListener('uqlibrary-api', function (e) {
            that.list = e.detail;
            that.fire('uqlibrary-api-library-hours', that.list);
          });
        },
        /**
        ...
        get: function (args) {
          ...
          this.set('$.list.uri', this.baseUri + '/' + this.mode);
          this.$.list.get();
        }
      });
    }());
        ...
        ready: function () {
          ...
          this.$.computers.addEventListener('uqlibrary-api', function(e) {
            ...
            var campusImages = {
                ...
                'GradEcoBus': 'https://app.library.uq.edu.au/assets/images/uq-buildings/st_lucia/colin_clark_bldg_39.jpg',
                ...
                'Mater': 'https://app.library.uq.edu.au/assets/images/uq-buildings/mater/mater_hospital_bldg.jpg',
                'PACE': 'https://app.library.uq.edu.au/assets/images/uq-buildings/pace/library.jpg',
                'SSAH': 'https://app.library.uq.edu.au/assets/images/uq-buildings/st_lucia/duhig_bldg_12_12a.jpg'
            };
...
(function () {
            Polymer({
                ...
                get: function (args) {
                    ...
                    var xobj = new XMLHttpRequest();
                    var fileName = this.resolveUrl('mock/training_get.json');
                    xobj.open('GET', fileName, true);
                    xobj.onreadystatechange = function () {
                        if (xobj.readyState == 4 && xobj.status == "200") {
                            var response = xobj.responseText;
                            that.fire('uqlibrary-api-training', JSON.parse(response));
                        }
                    };
                    xobj.send(null);

                    // Use when live API is done
...
(function() {
      Polymer({
         ...
         */
        logout: function () {
          document.location.href = "https://www.library.uq.edu.au/logout";
        }
      });
    })();
(function() {
...
(function () {
      Polymer({
        ...
        ready: function () {
          var that = this;
          this.$.papercut.addEventListener('uqlibrary-api', function (e) {
            that.papercut = e.detail;
            that.fire('uqlibrary-api-papercut-loaded', that.papercut);
          });
        },
        /**
         * Gets the computer availability.
         ...
         */
        get: function () {
          this.set('$.papercut.uri', this.baseUri);
          this.$.papercut.get();
        }
      });
    }());
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
    ...
    Polymer({
      ...
      properties: {
        ...
        websiteUrl: {
          type: String,
          value: 'https://app.library.uq.edu.au'
        },
